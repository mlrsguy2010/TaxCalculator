...
namespace TaxCalculator
{
    public partial class Form1 : Form
    {
        ...
        private decimal CalculateTax() //This is the declaration of the private method
        {
            decimal income = Convert.ToDecimal(txtIncome.Text);//receives Income Amount
            return tax; // returns tax amount (method hasnt been coded yet so tax shows error)
        }    
      }
